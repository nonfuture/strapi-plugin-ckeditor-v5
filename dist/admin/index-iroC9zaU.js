...
function SpecialCharactersEmoji(editor) {
  const specialCharacters = editor.plugins.get(ckeditor5.SpecialCharacters);
...
const editorConfig$1 = {
  ...
  htmlEmbed: {
    ...
    sanitizeHtml: (inputHtml) => {
      const outputHtml = DOMPurify__default.default.sanitize(inputHtml);
      return {
        html: outputHtml,
        hasChanged: true
      };
...
const index = {
  ...
  async register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./Field-js5I2FOK.js")).then((module2) => ({
