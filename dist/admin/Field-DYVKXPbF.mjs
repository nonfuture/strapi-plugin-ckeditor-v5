...
import React, { useState, useEffect, useMemo, createContext, useContext, useRef, useCallback, useImperativeHandle } from "react";
import { Flex, Modal, IconButton, Field as Field$1, Loader, Box } from "@strapi/design-system";
import { css, styled, useTheme } from "styled-components";
import { useStrapiApp, useField } from "@strapi/strapi/admin";
import { ClassicEditor } from "ckeditor5";
import { CKEditor } from "@ckeditor/ckeditor5-react";
import "ckeditor5/ckeditor5.css";
import { g as getPluginConfig, p as prefixFileUrlWithBackendUrl, i as isImageResponsive } from "./index-CFlB5HpY.mjs";
import "dompurify";
